...
class Connectivity {
  ...
  static Connectivity decode(Object result) {
    ...
    return Connectivity(
      type: ConnectivityType.values[result[0]! as int],
      wifiSignalStrength: result[1] as int?,
    );
  }
}

class _EcoModeApiCodec extends StandardMessageCodec {
  const _EcoModeApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is Connectivity) {
      buffer.putUint8(128);
...
class EcoModeApi {
  ...
  static const MessageCodec<Object?> pigeonChannelCodec = _EcoModeApiCodec();
  ...
  Future<Connectivity> getConnectivity() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.flutter_eco_mode.EcoModeApi.getConnectivity$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as Connectivity?)!;
    }
  }
}
