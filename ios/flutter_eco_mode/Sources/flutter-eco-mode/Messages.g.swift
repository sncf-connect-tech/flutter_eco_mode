...
struct Connectivity: Hashable {
  ...
  static func == (lhs: Connectivity, rhs: Connectivity) -> Bool {
    ...
    return deepEqualsMessages(lhs.type, rhs.type) && deepEqualsMessages(lhs.wifiSignalStrength, rhs.wifiSignalStrength)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("Connectivity")
    deepHashMessages(value: type, hasher: &hasher)
    deepHashMessages(value: wifiSignalStrength, hasher: &hasher)
  }
}
